...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Orders'], function () {
            ...
            Route::post('/order/status_livraison', 'Back\OrderController@status_livraison')->name('back.order.status_livraison');
        });
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/blogs', 'Front\FrontendController@maintenance_test')->name('front.blogs');
        ...
        // Route::get('product/test', 'Front\HomeCustomizeController@producttest')->name('front.get.producttest');
        //------------ COMPARE PRODUCT ------------//
        ...
        Route::post('/checkout/sendmail/admin', 'Front\CheckoutController@sending_email_admin')->name('front.checkout.mail_admin');
        ...
        Route::get('/checkout-livraison', 'Front\CheckoutController@livraison_page')->name('front.checkout.livraison');
...
Route::get('/updater/finalize', 'Front\FrontendController@finalize');
Route::get('/sendmailadmin', 'Front\TestController@sendmailadmin');
