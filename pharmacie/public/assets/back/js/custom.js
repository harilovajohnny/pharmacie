(function ($) {
    ...
    $(document).on('show.bs.modal', '#statusshipModal', function (e) {
        var button = $(e.relatedTarget);
        var shipmentId = button.data('id');
        var orderStatus = button.data('order-status');
    
        // Injecte les valeurs dans le formulaire
        $('#id_orders').val(shipmentId);
    
        // Met à jour l'action du formulaire avec le lien spécifique
        $('#statusshipModal form').attr('action', button.data('href'));
    });
