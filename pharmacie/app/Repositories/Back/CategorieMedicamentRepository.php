...
use App\{
    Models\Categorie_medicament,
    Helpers\ImageHelper
};
use App\Models\HomeCutomize;

class CategorieMedicamentRepository
{
    ...
    public function store($request)
    {
        ...
        Categorie_medicament::create($input);
    }

    /**
     * Update category.
     *
     * @param  \App\Http\Requests\CategorieMedicamentRequest  $request
     * @return void
     */
