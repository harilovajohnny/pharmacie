    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-primary  btn-sm" href="{{route('back.categorimedicament.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
        </div>
    </div>
		...
		<div class="card-body">
			...
			<div class="gd-responsive-table">
				<table class="table table-bordered table-striped" id="admin-table" width="100%" cellspacing="0">
					...
					<tbody>
              @include('back.categoriemedicament.table',compact('datas'))
					</tbody>
